 ...
 * @author Victoria
 */
public class DelDriver extends javax.swing.JFrame {

    /**
     * Creates new form DelDriver
     */
    public DelDriver() {
        initComponents();
    }
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtnActionPerformed
        ...
        if (ck.isExists()) {
            ...
            feedbackLabel.setText("Driver does not exist! You cannot delete it!");
            idText.setText("");
            passText.setText("");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DelDriver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
